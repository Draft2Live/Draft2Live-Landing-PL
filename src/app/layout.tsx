...
export function generateMetadata(): Metadata {
  ...
  return {
    metadataBase: new URL('https://pl.draft2live.com'),
    ...
    openGraph: {
      ...
      url: 'https://pl.draft2live.com/',
      siteName: 'Draft2Live',
      locale: 'pl_PL',
      type: 'website',
      images: [{
        url: '/og-images/og-pl-v2.png',
        width: 1200,
        height: 630,
        type: 'image/png',
        alt: 'Draft2Live — publikacja AI bezpośrednio do CMS',
      }],
    },
    twitter: {
...
function getJsonLd() {
  ...
  const orgSchema = {
    ...
    name: 'Draft2Live',
    url: 'https://pl.draft2live.com',
    logo: 'https://pl.draft2live.com/og-images/og-pl-v2.png',
